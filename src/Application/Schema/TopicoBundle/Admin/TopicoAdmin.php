<?php
namespace App\Application\Schema\TopicoBundle\Admin;
...
final class TopicoAdmin extends BaseAdmin
{

    public function toString(object $object): string
    {
        return $object instanceof Topico ? $object->getId()
    ...
    $datagrid->add('perguntaFrequentes', ModelFilter::class, [
        'label' => 'PerguntaFrequentes',
        'field_options' => [
            'multiple' => true,
            'choice_label'=> function (PerguntaFrequente $perguntaFrequentes) {
                return $perguntaFrequentes->getId()
                .' - '.$perguntaFrequentes->getPergunta()
                ;
            },
        ],
    ]);
