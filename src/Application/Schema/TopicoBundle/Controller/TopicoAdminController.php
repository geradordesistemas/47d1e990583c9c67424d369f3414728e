...
#[ACL\Admin(enable: true, title: 'Topico', description: 'Permissões modulo Topico')]
class TopicoAdminController extends BaseAdminController
{
    #[ACL\Admin(enable: true, title: 'Listar', description: 'Listar Topico')]
    ...
    #[ACL\Admin(enable: true, title: 'Visualizar', description: 'Visualizar Topico')]
    ...
    #[ACL\Admin(enable: true, title: 'Criar', description: 'Criar Topico')]
    ...
    #[ACL\Admin(enable: true, title: 'Editar', description: 'Editar Topico')]
    ...
    #[ACL\Admin(enable: true, title: 'Excluir', description: 'Excluir Topico')]
    ...
    #[ACL\Admin(enable: true, title: 'Excluir em Lote', description: 'Excluir Topico em lote')]
    ...
    #[ACL\Admin(enable: true, title: 'Exportar', description: 'Exportar Topico')]
    ...
    #[ACL\Admin(enable: true, title: 'Auditoria', description: 'Auditar Topico')]
