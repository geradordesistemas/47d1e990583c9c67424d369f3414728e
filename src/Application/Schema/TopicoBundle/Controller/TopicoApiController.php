...
#[Route('/api/topico', name: 'api_topico_')]
#[OA\Tag(name: 'Topico')]
#[ACL\Api(enable: true, title: 'Topico', description: 'Permissões do modulo Topico')]
class TopicoApiController extends BaseApiController
{
    ...
    /** ****************************************************************************************** */
    /**
     * Recupera a coleção de recursos — Topico.
     * Recupera a coleção de recursos — Topico.
    ...
    #[OA\Response(
        response: 200,
        description: 'Retorna Coleção de recursos Topico',
    ...
    #[ACL\Api(enable: true, title: 'Listar', description: 'Listar Topico')]
    ...
    /** ****************************************************************************************** */
    /**
     * Cria o Recurso — Topico.
     * Cria o Recurso — Topico.
     */
    #[OA\Response(
        response: 201,
        description: 'Retorna novo recurso Topico',
        content: new OA\JsonContent(
            properties: [
                new OA\Property(property: 'id', type: 'integer'),
                new OA\Property(property: 'nome', type: 'string'),
    ...
    #[ACL\Api(enable: true, title: 'Criar', description: 'Criar Topico')]
    ...
    #[ACL\Api(enable: true, title: 'Visualizar', description: 'Visualizar Topico')]
    public function showAction(Request $request, mixed $id): Response
    {
        ...
        if (!$object)
            return $this->json(['status' => false, 'message' => 'Topico não encontrado!'], 404);
    ...
    #[ACL\Api(enable: true, title: 'Editar', description: 'Editar Topico')]
    ...
    */
    ...
    #[ACL\Api(enable: true, title: 'Deletar', description: 'Deletar Topico')]
    public function deleteAction(mixed $id): Response
    {
        ...
        return $this->json(['status' => true, 'message' => 'Topico removido com sucesso.'], 204);
    }
