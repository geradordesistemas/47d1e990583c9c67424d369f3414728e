...
use App\Application\Schema\EmpresaBundle\Form\EmpresaType;
...
#[Route('/web/empresa', name: 'web_empresa_', methods: ['GET'])]
#[ACL\Web(enable: true, title: 'Empresa', description: 'Permissões do modulo Empresa')]
class EmpresaWebController extends BaseWebController
{
    ...
    {
        return "@ApplicationSchemaEmpresa/empresa/";
    }

    #[Route('', name: 'list', methods: ['GET'])]
    #[ACL\Web(enable: true, title: 'Listar', description: 'Lista Empresa')]
    ...
    #[ACL\Web(enable: true, title: 'Criar', description: 'Cria Empresa')]
    ...
    #[ACL\Web(enable: true, title: 'Visualizar', description: 'Visualiza Empresa')]
    ...
    #[ACL\Web(enable: true, title: 'Editar', description: 'Edita Empresa')]
    ...
    #[ACL\Web(enable: true, title: 'Deletar', description: 'Deleta Empresa')]
