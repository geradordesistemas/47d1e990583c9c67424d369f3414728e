...
#[Route('/api/perguntaFrequente', name: 'api_perguntaFrequente_')]
#[OA\Tag(name: 'PerguntaFrequente')]
#[ACL\Api(enable: true, title: 'PerguntaFrequente', description: 'Permissões do modulo PerguntaFrequente')]
class PerguntaFrequenteApiController extends BaseApiController
{
    ...
    /** ****************************************************************************************** */
    /**
     * Recupera a coleção de recursos — PerguntaFrequente.
     * Recupera a coleção de recursos — PerguntaFrequente.
    ...
    #[OA\Response(
        response: 200,
        description: 'Retorna Coleção de recursos PerguntaFrequente',
        content: new OA\JsonContent(
            properties: [
                new OA\Property(property: 'id', type: 'integer'),
                new OA\Property(property: 'pergunta', type: 'string'),
                new OA\Property(property: 'resposta', type: 'string'),
                new OA\Property(property: 'visivel', type: 'boolean'),
                new OA\Property(property: 'topico', type: 'integer' ),
            ],
            type: 'object'
        )
    )]
    #[Route('', name: 'list', methods: ['GET'])]
    #[ACL\Api(enable: true, title: 'Listar', description: 'Listar PerguntaFrequente')]
    public function listAction(Request $request): Response
    {
        ...
        $filter = new FilterDoctrine(
            ...
            request: $request,
            attributesFilters: [
                'pergunta', 'resposta', 'visivel', 'topico', 
            ]
        );
    ...
    /** ****************************************************************************************** */
    /**
     * Cria o Recurso — PerguntaFrequente.
     * Cria o Recurso — PerguntaFrequente.
     */
    #[OA\Response(
        response: 201,
        description: 'Retorna novo recurso PerguntaFrequente',
        content: new OA\JsonContent(
            properties: [
                new OA\Property(property: 'id', type: 'integer'),
                new OA\Property(property: 'pergunta', type: 'string'),
    ...
    #[ACL\Api(enable: true, title: 'Criar', description: 'Criar PerguntaFrequente')]
    ...
    /** ****************************************************************************************** */
    /**
     * Recupera o recurso — PerguntaFrequente.
     * Recupera o recurso — PerguntaFrequente.
     */
    #[OA\Parameter( name: 'id', description: 'Identificador do recurso', in: 'path')]
    #[OA\Response(
        response: 200,
        description: 'Retorna recurso PerguntaFrequente',
        content: new OA\JsonContent(
            properties: [
                new OA\Property(property: 'id', type: 'integer'),
                new OA\Property(property: 'pergunta', type: 'string'),
    ...
    #[ACL\Api(enable: true, title: 'Visualizar', description: 'Visualizar PerguntaFrequente')]
    public function showAction(Request $request, mixed $id): Response
    {
        ...
        if (!$object)
            return $this->json(['status' => false, 'message' => 'PerguntaFrequente não encontrado!'], 404);
    ...
    /** ****************************************************************************************** */
    /**
     * Substitui o recurso — PerguntaFrequente.
     * Substitui o recurso — PerguntaFrequente.
     */
    #[OA\Parameter( name: 'id', description: 'Identificador do recurso', in: 'path')]
    #[OA\Response(
    ...
    #[ACL\Api(enable: true, title: 'Editar', description: 'Editar PerguntaFrequente')]
    ...
    /** ****************************************************************************************** */
    /**
    * Remove o recurso — PerguntaFrequente.
    * Remove o recurso — PerguntaFrequente.
    */
    #[OA\Parameter( name: 'id', description: 'Identificador do recurso', in: 'path')]
    ...
    #[ACL\Api(enable: true, title: 'Deletar', description: 'Deletar PerguntaFrequente')]
    public function deleteAction(mixed $id): Response
    {
        ...
        return $this->json(['status' => true, 'message' => 'PerguntaFrequente removido com sucesso.'], 204);
    }
