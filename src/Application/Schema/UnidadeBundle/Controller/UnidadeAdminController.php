...
#[ACL\Admin(enable: true, title: 'Unidade', description: 'Permissões modulo Unidade')]
class UnidadeAdminController extends BaseAdminController
{
    #[ACL\Admin(enable: true, title: 'Listar', description: 'Listar Unidade')]
    ...
    #[ACL\Admin(enable: true, title: 'Visualizar', description: 'Visualizar Unidade')]
    ...
    #[ACL\Admin(enable: true, title: 'Criar', description: 'Criar Unidade')]
    ...
    #[ACL\Admin(enable: true, title: 'Editar', description: 'Editar Unidade')]
    ...
    #[ACL\Admin(enable: true, title: 'Excluir', description: 'Excluir Unidade')]
    ...
    #[ACL\Admin(enable: true, title: 'Excluir em Lote', description: 'Excluir Unidade em lote')]
    ...
    #[ACL\Admin(enable: true, title: 'Exportar', description: 'Exportar Unidade')]
    ...
    #[ACL\Admin(enable: true, title: 'Auditoria', description: 'Auditar Unidade')]
