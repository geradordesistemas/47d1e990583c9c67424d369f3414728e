...
#[ACL\Admin(enable: true, title: 'Bloco', description: 'Permissões modulo Bloco')]
class BlocoAdminController extends BaseAdminController
{
    #[ACL\Admin(enable: true, title: 'Listar', description: 'Listar Bloco')]
    ...
    #[ACL\Admin(enable: true, title: 'Visualizar', description: 'Visualizar Bloco')]
    ...
    #[ACL\Admin(enable: true, title: 'Criar', description: 'Criar Bloco')]
    ...
    #[ACL\Admin(enable: true, title: 'Editar', description: 'Editar Bloco')]
    ...
    #[ACL\Admin(enable: true, title: 'Excluir', description: 'Excluir Bloco')]
    ...
    #[ACL\Admin(enable: true, title: 'Excluir em Lote', description: 'Excluir Bloco em lote')]
    ...
    #[ACL\Admin(enable: true, title: 'Exportar', description: 'Exportar Bloco')]
    ...
    #[ACL\Admin(enable: true, title: 'Auditoria', description: 'Auditar Bloco')]
